...
public class ChooseAteaFragment extends Fragment {
    ...
    @Override
    public View onCreateView(LayoutInflater inflacter, ViewGroup container, Bundle savedInstanceState){
        View view = inflacter.inflate(R.layout.choose_area, container, false);
